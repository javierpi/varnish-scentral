...
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/6/35556/p35556.xml") { error 750 "/es/node/42729";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/4/35574/p35574.xml") { error 750 "/es/node/42778";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/8/35578/p35578.xml") { error 750 "/es/node/42727";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/2/35582/p35582.xml") { error 750 "/es/publications/list/topic/74";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/3/39983/p39983.xml") { error 750 "/es/node/42778";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/0/35600/p35600.xml") { error 750 "/es/node/43161";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/2/35602/p35602.xml") { error 750 "/es/node/43177";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/0/35550/p35550.xml") { error 750 "/es/taxonomy/term/74";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/1/35551/p35551.xml") { error 750 "/es/taxonomy/term/74";}
...
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/8/39958/p39958.xml") { error 750 "/es/node/42778";}
...
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/1/40211/p40211.xml") { error 750 "/es/node/42729";}
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/8/38778/p38778.xml") { error 750 "/es/node/42727";}
...
if (std.tolower(req.url) ~ "/mdg/noticias/paginas/2/43582/p43582.xml") { error 750 "/es/taxonomy/term/74";}
...
if (std.tolower(req.url) == "/mdg/go01/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/go02/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/go03/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/go04/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/go05/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/go06/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/go07/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/go08/") { error 750 "/es/node/42777";}
if (std.tolower(req.url) == "/mdg/l%c3%adneas_trabajo/") { error 750 "/es/node/42734";}
if (std.tolower(req.url) == "/mdg/trabajoestadistico/") { error 750 "/es/node/42735";}
if (std.tolower(req.url) == "/mdg/fortalecimiento_estadisticas/") { error 750 "/es/node/42735";}
if (std.tolower(req.url) == "/mdg/desarrollo/") { error 750 "/es/node/42735";}
if (std.tolower(req.url) == "/mdg/reportevances/") { error 750 "/es/node/42778";}
if (std.tolower(req.url) == "/mdg/avances/") { error 750 "/es/node/42778";}
if (std.tolower(req.url) == "/mdg/municipalizacionodm/") { error 750 "/es/node/42848";}
if (std.tolower(req.url) == "/mdg/buenaspracticas/") { error 750 "/es/node/42848";}
if (std.tolower(req.url) == "/mdg/documentosrelevantes/") { error 750 "/es/node/42848";}
